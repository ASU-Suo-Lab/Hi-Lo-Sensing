...
class LRMSDeformAttnFuser_Radar(LRMSDeformAttnFuser):
    ...
    def forward(self, batch_dict):
        ...
        fusion_f1 = self.DeformAttn1(query=self.with_pos_embed(radar_feats, pos2),
        ...
        fusion_f2 = self.DeformAttn2(query=self.with_pos_embed(radar_feats, pos2),
