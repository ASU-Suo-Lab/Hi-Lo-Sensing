...
To support this study, we develop a digital-twin-based multimodal dataset that integrates multi-resolution LiDAR and 4D radar within the [CARLA](https://github.com/carla-simulator/carla) simulation environment. This dataset enables controlled analysis of performance–cost trade-offs across different sensing configurations.
<div align="center">
  <img src="assets/digital_map.jpg" width="100%"/>
</div>

Furthermore, we bridge simulation and real-world deployment by collecting multimodal roadside data and using it to calibrate the radar sensing model, ensuring that simulated point cloud distributions closely match real-world characteristics.
<div align="center">
...
To train our final DRIFT-L model:
```shell
# multi-gpu training
cd tools
sh scripts/dist_train.sh 4 --cfg_file ./cfgs/carla_models/vv_conv_fusion.yaml
```

To train our final DRIFT-M model:
```shell
# multi-gpu training
cd tools
sh scripts/dist_train.sh 4 --cfg_file ./cfgs/carla_models/ll_msattn_bi_query.yaml
```
