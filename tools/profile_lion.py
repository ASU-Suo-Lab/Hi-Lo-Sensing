...
def parse_config():
    parser = argparse.ArgumentParser(description='profile LION hotspots')
    ...
    parser.add_argument('--save_dir', type=str, default='output/lion_profile', help='trace output directory')
    parser.add_argument('--set', dest='set_cfgs', default=None, nargs=argparse.REMAINDER, help='extra config keys')
