...
class Kitti(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # print(f'gt_names: {type(data_dict["gt_names"])}')
        # print(f'difficulty: {type(data_dict["difficulty"])}')
        # print(f'gt_labels: {type(data_dict["gt_labels"])}')
        # print(f'pts: {type(data_dict["pts"])}')
        # print(f'gt_bboxes_3d: {type(data_dict["gt_bboxes_3d"])}')
        # assert False
